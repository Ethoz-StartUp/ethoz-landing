...
<svelte:head>
  ...
  <meta property="og:url" content="https://ethoz.cl/recursos/plan-respuesta-brechas" />
  ...
  <link rel="canonical" href="https://ethoz.cl/recursos/plan-respuesta-brechas" />
  {@html `<script type="application/ld+json">${JSON.stringify({
    "@context": "https://schema.org",
    "@type": "HowTo",
    "name": t('resBreachResponse.schema_name'),
    "description": t('resBreachResponse.schema_description'),
    "url": "https://ethoz.cl/recursos/plan-respuesta-brechas",
...
<main id="main-content" class="min-h-dvh bg-background">
  ...
  <div class="mx-auto max-w-7xl px-4 py-10 sm:py-14">
    <div class="mb-12 border-b border-border pb-10">
      ...
      <h1 class="page-title">{t('resBreachResponse.hero_title')}</h1>
