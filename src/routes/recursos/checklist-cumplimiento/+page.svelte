...
<svelte:head>
  ...
  <meta property="og:url" content="https://ethoz.cl/recursos/checklist-cumplimiento" />
  ...
  <link rel="canonical" href="https://ethoz.cl/recursos/checklist-cumplimiento" />
  {@html `<script type="application/ld+json">${JSON.stringify({
    "@context": "https://schema.org",
    "@type": "HowTo",
    "name": t('resComplianceChecklist.og_title'),
    "description": t('resComplianceChecklist.meta_description'),
    "url": "https://ethoz.cl/recursos/checklist-cumplimiento",
