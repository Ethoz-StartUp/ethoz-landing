...
<main class="flex min-h-dvh flex-col bg-background">
  ...
  <section class="py-12 sm:py-14">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div class="mx-auto max-w-2xl text-center">
        <p class="text-mockup-sm font-semibold uppercase tracking-[0.18em] text-primary">{t('featurePage.emergency.protocols_eyebrow')}</p>
  ...
  <section class="bg-foreground py-20 text-background sm:py-24" aria-labelledby="emergency-cta">
    <div class="mx-auto max-w-7xl px-4 text-center sm:px-6 lg:px-8">
      ...
      <p class="mt-6 text-mockup-sm font-semibold uppercase tracking-[0.18em] text-background/85">{t('featurePage.emergency.finalCta.eyebrow')}</p>
