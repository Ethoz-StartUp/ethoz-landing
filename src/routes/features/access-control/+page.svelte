...
<main class="flex min-h-dvh flex-col bg-background">
      ...
      <div class="mt-6 grid items-start gap-10 lg:grid-cols-2 lg:gap-16">
        ...
        <div class="w-full rounded-xl border border-border bg-card shadow-card-hover overflow-hidden">
          <div class="flex items-center gap-2 border-b border-border px-4 py-2.5">
            ...
            <span class="ml-2 text-[11px] font-medium text-muted-foreground">{t('featurePage.accessControl.matrix_titlebar')}</span>
          </div>
          ...
          <div class="px-4 py-2.5 border-t border-border bg-muted/20">
            <p class="text-[9px] text-muted-foreground">{t('featurePage.accessControl.matrix_footnote')}</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="py-12 sm:py-14">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <p class="mb-2 text-sm font-bold uppercase tracking-widest text-primary">{t('featurePage.accessControl.byrole_eyebrow')}</p>
