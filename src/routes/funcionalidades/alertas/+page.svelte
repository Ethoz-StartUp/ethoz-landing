...
<svelte:head>
  ...
  <meta property="og:url" content="https://ethoz.cl/funcionalidades/alertas" />
  ...
  <link rel="canonical" href="https://ethoz.cl/funcionalidades/alertas" />
...
<div class="flex min-h-dvh flex-col bg-background">
  ...
  <!-- Editorial anchor — alert architecture -->
  <EditorialSection
    id="alerts-editorial"
    eyebrow={t('featurePage.alerts.editorial.eyebrow')}
    statement={t('featurePage.alerts.editorial.statement')}
    body={t('featurePage.alerts.editorial.body')}
  />
