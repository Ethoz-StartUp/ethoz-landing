...
<svelte:head>
  ...
  <meta property="og:url" content="https://ethoz.cl/funcionalidades/ficha-alumno" />
  ...
  <link rel="canonical" href="https://ethoz.cl/funcionalidades/ficha-alumno" />
...
<div class="flex min-h-dvh flex-col bg-background">
  ...
  <section class="py-12 sm:py-14">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      ...
      <!-- Timeline -->
      <div aria-hidden="true" class="relative pl-6 border-l border-border space-y-8">
        {#each [
