...
<div class="min-h-screen bg-background">
      ...
      {#each allLetters as letter, i}
        ...
        <section id={letter}>
          <div class="flex items-baseline justify-between border-b border-border pb-4">
            ...
            <span class="text-mockup-sm font-mono font-semibold uppercase tracking-[0.1em] text-muted-foreground" data-numeric>
            ...
            {#each glossary[letter] as item}
              <div class="grid gap-3 py-6 sm:grid-cols-[minmax(0,12rem)_minmax(0,1fr)] sm:gap-8">
                <dt>
                  ...
                  {#if item.tag}
                    <p class="mt-1 text-mockup-sm font-mono font-semibold uppercase tracking-[0.1em] {tagColors[item.tag] ?? 'text-muted-foreground'}">{item.tag}</p>
                  {/if}
                </dt>
                <dd>
  ...
  <section class="py-12 bg-background border-t border-border">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <p class="text-mockup-sm font-mono font-semibold uppercase tracking-[0.1em] text-muted-foreground mb-5">{t('glosario.related_eyebrow')}</p>
