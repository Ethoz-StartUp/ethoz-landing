...
<svelte:head>
  ...
  <meta property="og:url" content="https://ethoz.cl/nosotros" />
  ...
  <link rel="canonical" href="https://ethoz.cl/nosotros" />
...
<div class="flex min-h-dvh flex-col bg-background">
  ...
  <!-- FINAL CTA — dark navy -->
  <section class="bg-secondary py-20 text-foreground sm:py-24" aria-labelledby="final-cta-about">
    <div class="mx-auto max-w-7xl px-4 text-center sm:px-6 lg:px-8">
      <span class="mx-auto block h-px w-12 bg-foreground/60" aria-hidden="true"></span>
      <p class="mt-6 text-mockup-sm font-mono font-semibold uppercase tracking-[0.1em] text-foreground/85">{t('about.cta_eyebrow')}</p>
      <h2 id="final-cta-about" class="mt-5 font-heading text-3xl leading-[1.15] text-foreground sm:text-4xl">
        {t('about.cta.title')}
      </h2>
      ...
      <div class="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
        ...
        >
          <span class="border-b border-foreground/60 pb-0.5 transition-colors group-hover:border-foreground">{t('about.cta_secondary')}</span>
        </a>
      </div>
    </div>
  </section>
