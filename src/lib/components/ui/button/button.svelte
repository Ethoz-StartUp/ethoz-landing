<script lang="ts" module>
	...
	export const buttonVariants = tv({
		...
		variants: {
			variant: {
				default: "bg-primary text-primary-foreground shadow-glow-primary hover:shadow-glow-primary-hover hover:-translate-y-px [a]:hover:bg-primary/95 hover:bg-primary/95",
				outline: "border-border bg-card hover:bg-muted hover:text-foreground hover:shadow-card hover:-translate-y-px dark:bg-input/30 dark:border-input dark:hover:bg-input/50 aria-expanded:bg-muted aria-expanded:text-foreground",
