...
<p style="font-size: 0.875rem; line-height: 1.75; margin: 0;">La Ley 21.719 permite multas de hasta 20.000 UTM (más de $1.300 millones CLP) y la Ley 21.663 agrega sanciones del 4% de ingresos globales. Los sostenedores necesitan audit log, cifrado, control de acceso y gestión de consentimientos antes de diciembre de 2026.</p>
</div>
<h2>El nuevo régimen sancionatorio rige desde diciembre de 2026</h2>
<p>Durante años, la protección de datos personales en Chile fue una obligación sin consecuencias reales. Eso terminó. La Ley 21.719, publicada en diciembre de 2024, creó la <strong>Agencia de Protección de Datos Personales</strong> con facultades fiscalizadoras, sancionatorias y normativas. Para los sostenedores escolares, esto no es teoría: es el entorno regulatorio al que deben adecuarse antes de diciembre de 2026.</p>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>Gravísima</td>
      <td>20.000 UTM (más de $1.300 millones CLP)</td>
      <td>40.000 UTM</td>
    </tr>
  </tbody>
</table>

<p>Los valores en pesos son referenciales y dependen del valor de la UTM al momento de la sanción. Las infracciones gravísimas incluyen tratamiento ilícito de datos sensibles, vulneraciones masivas, y reincidencia dentro de 24 meses.</p>
...
<p>Los sostenedores operan como <em>responsables del tratamiento</em> de datos de menores de edad, categoría que merece protección reforzada bajo la ley. Las siguientes prácticas comunes en colegios chilenos configuran infracciones bajo la nueva ley:</p>
...
<h2>La Agencia se prepara para fiscalizar: lo que esto significa en la práctica</h2>
<p>La Agencia de Protección de Datos Personales contará con un equipo técnico especializado y potestades de fiscalización de oficio, es decir, podrá iniciar investigaciones sin denuncia previa desde diciembre de 2026. El sector educacional, por manejar datos de menores y datos sensibles de salud, es prioritario en su agenda regulatoria.</p>
...
<div style="margin-top: 2.5rem; border: 1px solid var(--border); border-radius: 0.75rem; padding: 1.25rem 1.5rem; background: var(--secondary);">
  ...
  <p style="font-size: 0.875rem; line-height: 1.75; margin: 0;">Las multas y sanciones descritas en este artículo están establecidas en la Ley 21.719, sobre protección y tratamiento de los datos personales.</p>
