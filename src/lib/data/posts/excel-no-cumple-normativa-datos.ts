...
export const post: BlogPost = {
	...
	description:
		'La Circular N°30 de la Superintendencia de Educación y la Ley 21.719 imponen requisitos que las hojas de cálculo no pueden cumplir estructuralmente: sin trazabilidad, sin control de acceso granular y sin continuidad entre años escolares, Excel es un pasivo legal disfrazado de herramienta de gestión.',
	date: '2026-02-10',
...
<h2>Qué exige la Circular N°30 de la Superintendencia de Educación</h2>
...
<p>La objeción más frecuente a migrar a sistemas de gestión es el costo. Es un argumento válido que merece una respuesta igualmente concreta. Las multas por infracción grave bajo la Ley 21.719 alcanzan las 5.000 UTM (~$350 millones CLP). Las multas por infracción gravísima, como vulnerar datos sensibles de menores, alcanzan las 20.000 UTM o el 4% de los ingresos anuales, el monto que resulte mayor. Para un colegio con matrícula de 600 estudiantes y aranceles de $150.000 mensuales, el 4% de los ingresos anuales supera los $40 millones.</p>
