...
<p style="font-size: 0.875rem; line-height: 1.75; margin: 0;">Las principales plataformas de gestión escolar en Chile fueron construidas para administrar el libro de clases, no para cumplir la Ley 21.719. Ninguna documenta públicamente consentimiento parental gestionado, auditoría de accesos, aislamiento de datos entre establecimientos ni cifrado de información sensible. Agregar esas capacidades después de construir el sistema cuesta entre 3 y 5 veces más que haberlas diseñado desde el inicio.</p>
</div>
...
<p>La ley establece obligaciones técnicas y organizativas que no son ambiguas. Cada una de ellas requiere que el sistema de gestión escolar tenga capacidades específicas. La siguiente tabla compara, según el texto de la ley, lo que esta exige con lo que la documentación pública de las plataformas de gestión escolar actuales permite verificar:</p>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>Art. 20</td>
      <td>Su documentación pública no describe gestión digital de consentimiento. El proceso suele quedar en formularios físicos sin trazabilidad digital.</td>
    </tr>
    <tr>
      <td>Registro de auditoría de cada acceso a datos personales (quién, cuándo, desde dónde)</td>
      <td>Art. 14 ter</td>
      <td>Según su documentación pública, los logs de actividad, cuando existen, no están estructurados como evidencia auditable ni son exportables para la Agencia.</td>
    </tr>
    <tr>
      <td>Cifrado de datos sensibles: registros médicos, notas psicológicas, datos disciplinarios</td>
      <td>Art. 14 quáter</td>
      <td>Su documentación pública no describe cifrado a nivel de campo, necesario para datos de categoría especial.</td>
    </tr>
    <tr>
      <td>Respuesta a derechos ARCO+P en 30 días hábiles con datos completos y portables</td>
      <td>Arts. 11 a 15 y 40</td>
      <td>Su documentación pública no menciona exportación estructurada de todos los datos de un alumno ni portabilidad interoperable en el roadmap.</td>
    </tr>
    <tr>
      <td>Notificación de brechas de seguridad a la Agencia en 72 horas</td>
      <td>Art. 30</td>
      <td>Sin inventario de datos ni protocolo de incidentes integrado en la plataforma, cumplir el plazo de 72 horas es operacionalmente muy difícil.</td>
    </tr>
    <tr>
      <td>Privacidad por diseño y por defecto</td>
      <td>Art. 16 bis</td>
      <td>Los sistemas fueron construidos para maximizar acceso a la información, no para minimizar la exposición de datos. El principio de minimización no formó parte de su diseño original.</td>
    </tr>
    <tr>
...
<p>El tercero es la <strong>exposición legal durante el período de transición</strong>. Si entre enero y diciembre de 2026 ocurre una brecha de seguridad en una plataforma sin auditoría ni cifrado, el sostenedor responde ante la Agencia por los datos de cientos o miles de menores. Las <a href="/blog/multas-proteccion-datos-sostenedores">multas pueden llegar a 20.000 UTM (más de $1.300 millones) o al 4% de los ingresos anuales</a>, el monto que resulte mayor. No hay período de gracia para brechas que ocurran antes de la entrada en vigencia de la ley si el responsable podría haber tomado medidas preventivas.</p>
...
<p>La Ley 21.719 no pregunta si el colegio usa una plataforma reconocida o con miles de establecimientos clientes. Pregunta si los datos de los menores están protegidos con los estándares que la ley define. Y en ese test, la antigüedad del proveedor no es un activo: es, en muchos casos, exactamente el problema. Más años en el mercado suelen significar una arquitectura que nunca contempló este escenario.</p>
