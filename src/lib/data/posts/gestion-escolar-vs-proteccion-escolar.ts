...
<p>La pregunta que vale hacerse es más simple: <em>¿su plataforma actual puede demostrar, ante una fiscalización de la Agencia de Protección de Datos Personales, que nadie accedió a información que no le correspondía? ¿Puede mostrar quién autorizó el retiro de cada alumno en los últimos seis meses? ¿Puede acreditar que el portero estaba informado sobre la restricción judicial activa el día que llegó el padre sin custodia?</em></p>
