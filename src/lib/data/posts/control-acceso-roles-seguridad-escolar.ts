...
<p>En el contexto de la Ley 21.719, RLS es lo que hace posible el cumplimiento en arquitecturas <em>multi-tenant</em>, es decir, sistemas compartidos entre múltiples establecimientos. Sin RLS, el aislamiento de datos entre sedes es una promesa sin respaldo técnico. Con RLS, es una garantía estructural que puede demostrarse ante la Agencia de Protección de Datos Personales.</p>
...
<p>La Agencia de Protección de Datos Personales, en una fiscalización, puede solicitar evidencia de que el establecimiento ha implementado controles de acceso adecuados. Un sistema sin RBAC no puede demostrar ese cumplimiento. Un sistema con RBAC bien configurado puede exportar el mapa completo de permisos por rol, el historial de accesos por usuario y los cambios de configuración realizados: todo el audit log que la Agencia necesita ver.</p>
