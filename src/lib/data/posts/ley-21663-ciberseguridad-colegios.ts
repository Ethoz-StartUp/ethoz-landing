...
<p style="font-size: 0.875rem; line-height: 1.75; margin: 0;">La Ley 21.663 de Ciberseguridad, vigente desde 2024, impone obligaciones técnicas directas a los operadores de infraestructura digital en Chile, categoría en la que entran los establecimientos educacionales que gestionan datos de menores. Cifrado obligatorio, reporte de incidentes en 72 horas y registros de auditoría son las tres exigencias centrales. ${BRAND} implementa estos controles de forma nativa con pgcrypto, RLS y auditoría sobre Cloud SQL/PostgreSQL.</p>
</div>
...
<ul>
  ...
  <li>La obligación de notificación a la Agencia de Protección de Datos Personales bajo la Ley 21.719.</li>
...
<ul>
  <li><strong>Infracciones leves:</strong> multas de hasta 5.000 UTM (~$350 millones de pesos).</li>
  <li><strong>Infracciones graves:</strong> multas de hasta 10.000 UTM y prohibición temporal de operar ciertos sistemas.</li>
  <li><strong>Infracciones gravísimas:</strong> multas de hasta 20.000 UTM (más de $1.300 millones), con agravantes si el incidente afecta a menores de edad o si hubo negligencia en la notificación obligatoria.</li>
</ul>
...
<h2>Cómo ${BRAND} implementa nativamente las exigencias de la Ley 21.663</h2>
<p>${BRAND} fue diseñado desde su arquitectura base con las exigencias de la Ley 21.663 como requisito no negociable. Las tres obligaciones técnicas centrales están implementadas de manera nativa:</p>
...
<p>El <strong>Row-Level Security (RLS) de PostgreSQL</strong> implementa control de acceso a nivel de fila. Esto significa que las políticas de acceso no se gestionan solo en la capa de aplicación, que puede ser vulnerada, sino en la base de datos misma. Un usuario que accede con credenciales válidas pero sin los permisos correctos simplemente no ve los datos, aunque intente consultarlos directamente. Esta es la implementación más robusta posible del principio de mínimo privilegio que la Ley 21.663 exige.</p>
