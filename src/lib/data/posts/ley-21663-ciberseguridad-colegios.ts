...
<p style="font-size: 0.875rem; line-height: 1.75; margin: 0;">La Ley 21.663 de Ciberseguridad, vigente desde 2024, impone obligaciones técnicas directas a los operadores de infraestructura digital en Chile, categoría en la que entran los establecimientos educacionales que gestionan datos de menores. Cifrado obligatorio, reporte de incidentes en 72 horas y registros de auditoría son las tres exigencias centrales. ${BRAND} cumple nativamente con pgcrypto, RLS y auditoría sobre Cloud SQL/PostgreSQL.</p>
</div>
